...
export default function AddTransactionAccountModal({
  open,
  onClose,
  accountName,
  setAccountName,
  ...
  const [errors, setErrors] = React.useState({ accountName: '', accountNumber: '', status: '', accountType: '' });
  ...
  const handleSave = () => {
    let newErrors = { accountName: '', accountNumber: '', status: '', accountType: '' };
    ...
    if (!newErrors.accountName && !newErrors.accountNumber && !newErrors.status && !newErrors.accountType) {
      onSave();
    }
  };
